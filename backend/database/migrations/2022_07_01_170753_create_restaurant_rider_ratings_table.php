...
class CreateRestaurantRiderRatingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('restaurant_rider_ratings', function (Blueprint $table) {
            $table->id();
            $table->string('restaurant_rider_rating_id');
    ...
    {
        Schema::dropIfExists('restaurant_rider_ratings');
    }
}
